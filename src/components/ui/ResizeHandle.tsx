    ...
    >
      {isX ? (
        ...
        <>
          ...
          <div className="absolute left-1/2 top-1/2 flex h-3 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-surface shadow-sm transition-colors group-hover:border-accent/50">
            <span className="h-[2px] w-5 rounded-full bg-foreground/25 group-hover:bg-accent/70" />
          </div>
        </>
      )}
    </div>
