...
function DailyReportView() {
  const { report: todayReport } = useWorkday();
    ...
    <div>
      ...
      <header className="flex items-start justify-between gap-4 border-b-2 border-foreground/10 pb-5">
        <div>
          ...
          <h1 className="mt-1.5 text-xl font-bold text-foreground">일간 리포트</h1>
        </div>
      ...
      <div className="space-y-6">
        ...
        {difficultExpressions.length > 0 && (
          <ReportSection index="05" title="오늘 어려웠던 표현" tone="warning">
