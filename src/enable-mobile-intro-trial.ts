...
const steps: PreviewStep[] = [
  ...
  },
  {
    ...
    points: [
      "연속 출근 5일마다 적립연차가 +1 — 하루 빠져도 연차가 대신 덮어줘서 기록이 안 끊겨요(둘 다 없을 때만 0부터 다시).",
      "연속 3·7·30·100일, 누적 20·50·100일 — 마일스톤 7개가 차례로 열려 오늘 하루가 기록으로 남아요.",
    ],
    screen: `
  ...
  {
    label: "승급",
    title: "사원에서 이사까지, 쌓인 하루가 직급으로 보여요",
    subtitle: "직급으로 성장을 확인하고, 인사평가에 남긴 피드백은 다음 날 대화에 그대로 반영돼요. 승급하면 직급 연차와 새 직급 캐릭터도 열려요.",
    points: [
      "평가에서 ‘이렇게 말해줬으면’ 하고 남기면, 다음 날부터 동료·상사·거래처가 실제로 그 방식으로 말을 걸어와요.",
      "평가 문제도 내가 자주 틀렸던 교정 이력에서 만들어져요 — 쓸수록 나에게 맞게 다듬어지는 구조예요.",
    ],
    screen: `
